...
export const INITIAL_VET_DOCTORS = [
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1629909613654-20e3650275cc?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1628009368231-7718fc89829e?q=80&w=800&auto=format&fit=crop',
    inClinicFee: 750,
    videoConsultFee: 449,
    homeVisitFee: 1400,
  ...
  },
  {
    ...
    phone: '+91 98765 43210',
    whatsapp: '919876543210',
    avatar: 'https://images.unsplash.com/photo-1606425134789-5f21272fc4d6?q=80&w=800&auto=format&fit=crop',
    coverImage: 'https://images.unsplash.com/photo-1629909613654-20e3650275cc?q=80&w=800&auto=format&fit=crop',
    inClinicFee: 900,
    videoConsultFee: 599,
    homeVisitFee: 1800,
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1584813470769-d758f2d59ab5?q=80&w=800&auto=format&fit=crop',
    inClinicFee: 700,
    videoConsultFee: 399,
    homeVisitFee: 1200,
  ...
  },
  {
    ...
    phone: '+91 98765 43210',
    whatsapp: '919876543210',
    avatar: 'https://images.unsplash.com/photo-1628009368231-7718fc89829e?q=80&w=800&auto=format&fit=crop',
    coverImage: 'https://images.unsplash.com/photo-1606425134789-5f21272fc4d6?q=80&w=800&auto=format&fit=crop',
    inClinicFee: 1000,
    videoConsultFee: 650,
    homeVisitFee: 2000,
    petCategories: ['Dogs', 'Cats', 'All'],
...
export const INITIAL_VET_PRESCRIPTIONS = [
  {
    ...
    vciRegistration: 'VCI/2010/KA-08492',
    clinicName: 'Josh Pets Hub Luxury Vet Clinic & Diagnostic Center',
    clinicAddress: 'MG Road, Bangalore, Karnataka • Phone: +91 98765 43210',
    createdAt: new Date().toISOString()
  },
  {
    id: 'RX-2026-0839',
