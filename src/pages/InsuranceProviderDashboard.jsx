...
const InsuranceProviderContent = ({ activeTab }) => {
  return (
        ...
        <div className="p-6 pt-12 space-y-8">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="w-full px-4">
              ...
              <span className="inline-flex mt-2 bg-[#ffd000]/10 text-[#0F2E23] border border-[#ffd000]/30 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest items-center justify-center gap-1 shadow-sm mx-auto">
                <ShieldCheck size={12} className="text-amber-500" /> Top Provider
              </span>
            </div>
          </div>
          ...
          <nav className="space-y-1.5 pt-4">
            ...
            <ul className="space-y-1">
              {[
                { id: 'policies', label: 'Active Policies', count: 12, icon: ShieldCheck },
                { id: 'claims', label: 'Pending Claims', count: 2, icon: AlertCircle },
                { id: 'messages', label: 'Client Inquiries', count: 5, icon: MessageSquare },
                { id: 'reviews', label: 'Customer Reviews', extra: '4.7 ★', icon: Heart },
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Manage pet insurance policies, pending claims, and active leads.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5 mb-10">
          ...
          <div className="bg-white border border-slate-200 p-5 rounded-2xl hover:border-[#0F2E23]/30 transition duration-300 shadow-sm hover:shadow-md group">
            <div className="flex justify-between items-center mb-4">
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Total Active Policies</span>
          ...
          <div className="bg-white border border-slate-200 p-5 rounded-2xl hover:border-emerald-500/50 transition duration-300 shadow-sm hover:shadow-md group relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 relative z-10">
              <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Pending Claims</span>
            ...
            <div className="text-[10px] text-emerald-600 font-black uppercase tracking-wider mt-2 relative z-10">Requires review</div>
          </div>
          ...
          <div className="bg-white border border-slate-200 p-5 rounded-2xl hover:border-rose-500/50 transition duration-300 shadow-sm hover:shadow-md group relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4 relative z-10">
              <span className="text-[10px] font-black text-rose-600 uppercase tracking-widest">Approved Claims</span>
            ...
            <div className="text-[10px] text-rose-600 font-black uppercase tracking-wider mt-2 relative z-10">Processed</div>
          </div>
