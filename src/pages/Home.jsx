    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white space-y-6">
          <span className="text-xs font-semibold tracking-widest text-accent uppercase flex items-center justify-center gap-1.5 animate-pulse">
            <Sparkles size={14} /> Pawora Premium Living
          </span>
          <h1 className="font-serif text-4xl md:text-6xl text-secondary leading-tight">
            Better Care For Every <br />Kind Of Companion.
          </h1>
          <p className="text-sm md:text-base text-secondary-dark max-w-2xl mx-auto leading-relaxed font-light">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            ...
            <button 
              ...
              className="px-8 py-3.5 border border-white text-white font-medium text-sm tracking-widest hover:bg-white hover:text-primary transition duration-300 uppercase cursor-pointer"
            >
              EXPLORE PET CARE
            </button>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-white border border-beige p-8 shadow-sm">
      ...
      <section className="bg-primary text-secondary py-20 px-6 md:px-12">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <button 
                ...
                className="px-8 py-3.5 bg-accent text-primary font-bold text-xs tracking-widest hover:bg-white hover:text-primary transition duration-300 uppercase cursor-pointer"
              >
