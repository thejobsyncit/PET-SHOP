...
export const categories = [
  ...
  { name: 'Dog Beds & Cotes', slug: 'dog-beds', petType: 'dogs', description: 'Cozy and orthopedic beds for sleeping', image: 'https://images.unsplash.com/photo-1541599540903-216a46ca1df0?q=80&w=600' },
  // Birds
  ...
  { name: 'Cages & Habitat', slug: 'bird-cages', petType: 'birds', description: 'Spacious and safe cages for birds', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=600' },
  // Reptiles
...
export const products = [
  // ------------------ DOG PRODUCTS ------------------
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1541599540903-216a46ca1df0?q=80&w=800'
    ],
    category: 'Dog Food',
  ...
  },
  {
    ...
    stock: 8,
    lowStockThreshold: 2,
    images: ['https://images.unsplash.com/photo-1541599540903-216a46ca1df0?q=80&w=800'],
  ...
  },
  {
    ...
    stock: 15,
    lowStockThreshold: 3,
    images: ['https://images.unsplash.com/photo-1589924691995-400dc9ecc119?q=80&w=800'],
    category: 'Dog Food',
    subcategory: 'Dog Food',
    petType: 'dogs',
    isFeatured: false,
  ...
  },
  {
    ...
    stock: 90,
    lowStockThreshold: 10,
    images: ['https://images.unsplash.com/photo-1607619056574-7b8d304b3b86?q=80&w=800'],
    category: 'Treats',
  ...
  // ------------------ BIRD PRODUCTS ------------------
  {
    ...
    stock: 40,
    lowStockThreshold: 5,
    images: ['https://images.unsplash.com/photo-1522858547137-f1dcec554f55?q=80&w=800'],
    category: 'Bird Food',
  ...
  // ------------------ REPTILE PRODUCTS ------------------
  {
    ...
    stock: 4,
    lowStockThreshold: 1,
    images: ['https://images.unsplash.com/photo-1504450758481-7338eaa75e6a?q=80&w=800'],
    category: 'Terrariums',
